    ...
    <div class="bg-white dark:bg-gray-800 flex relative z-20 items-center overflow-hidden">
        <div class="container mx-auto px-6 flex relative py-16">
            ...
            <div class="hidden sm:block sm:w-1/3 lg:w-3/5 relative">
                <img src="https://www.indiafilings.com/learn/wp-content/uploads/2018/03/Additional-Director.jpg" class="max-w-xs md:max-w-sm m-auto"/>
            </div>
        </div>
    </div>
</main> -->
...
<script>
import Director from '../components/about/Director.vue'
export default {
