<template>
  <section>
      <h3 class="text-3xl font-bold mb-6 text-red-700">What Our Students Say</h3>
      <div class="py-10 radius-for-skewed">
          <div class="container mx-auto px-2">  
            <div class="max-w-6xl p-4 flex flex-wrap justify-center items-center">
                
              <div class="w-full pr-4">
                <svg class="mb-4 text-red-600 h-10" viewbox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 class="mb-6 bg-gray-50 text-2xl lg:text-2xl">Maecenas nibh purus, pharetra ac felis sed, elementum molestie urna. Nunc at arcu non ipsum.</h3>
                <div class="flex flex-1">
                <div class="mb-6 w-full lg:w-1/3 text-center flex">
                <img class="mb-6 mx-auto w-10 h-10 rounded-full object-cover" src="https://images.unsplash.com/photo-1564564321837-a57b7070ac4f?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=1055&amp;q=80" alt="">
                <span class="flex-wrap">
                <h4 class="text-md ml-2 flex-none ">Ian Brown</h4>
                <p class="text-red-600 flex-none ">Head of Development</p>
                </span>
              </div>
                <div class="ml-6">
                  <button class="mr-1 bg-gray-200 rounded-full p-1"></button>
                  <button class="mr-1 bg-gray-200 rounded-full p-1"></button>
                  <button class="mr-1 bg-red-600 rounded-full p-1"></button>
